...
var _const ={
    IFRAME_COMMS_MESSAGE_TYPE : "__embedded_comms__"
}
...
exports.IFRAME_COMMS_MESSAGE_TYPE = void 0;
...
var _guestTokenRefresh = require("./token");
...
async function embedDashboard(_ref) {
  ...
  async function mountIframe() {
    return new Promise(resolve => {
      ...
      //iframe.src = `${supersetDomain}/embed/dashboard/${id}${dashboardConfig}`;
